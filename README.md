...
> 深色模式下的主日历界面，左侧管理人员 / 节假日 / 请假记录，右侧按月展示排班结果。

<p align="center">
  <img src="./assets/03-desktop-main-dark-calendar.png" alt="居委会排班表桌面端主界面" width="100%">
</p>
...
<p align="center">
  <img src="./assets/03-desktop-main-dark-calendar.png" alt="桌面端排班日历" width="100%">
</p>
...
> 可将月度排班概览推送到飞书群，方便值班人员快速查看。

<p align="center">
  <img src="./assets/01-mobile-month-schedule-card.png" alt="飞书月度排班卡片" width="45%">
</p>
...
> 支持换班提醒、人员变动提醒、测试推送等机器人通知。

<p align="center">
  <img src="./assets/02-mobile-feishu-swap-and-test-push.png" alt="飞书换班提醒和测试推送" width="45%">
</p>
...
> 可以导入历史值班表，自动学习不同班次的人员轮转顺序。

<p align="center">
  <img src="./assets/04-desktop-order-learning.png" alt="WPS Office 顺序学习" width="100%">
</p>
...
> 支持通过 API 导入节假日、调休数据，减少手动维护成本。

<p align="center">
  <img src="./assets/05-desktop-holiday-api-import.png" alt="节假日调休 API 导入" width="100%">
</p>
...
<p align="center">
  <img src="./assets/02-mobile-feishu-swap-and-test-push.png" alt="飞书推送效果" width="45%">
</p>
